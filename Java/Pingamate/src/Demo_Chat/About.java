...
public class About extends JDialog {
	...
	public About() {
		...
		}
		{
			...
			lblPingamateV.setForeground(Color.LIGHT_GRAY);
			lblPingamateV.setBackground(Color.WHITE);
		...
		}
		{
			...
			txtrCreatedBy.setForeground(Color.LIGHT_GRAY);
			txtrCreatedBy.setBackground(Color.DARK_GRAY);
